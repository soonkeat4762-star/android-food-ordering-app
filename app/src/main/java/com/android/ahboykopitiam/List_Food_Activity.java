...
public class List_Food_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnbackFoods = findViewById(R.id.btnbackfood);
        btnbackFoods.setOnClickListener(v -> {
    ...
    private void showBackConfirmationDialog() {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(List_Food_Activity.this);
        builder.setTitle("Menu Foods");
        builder.setMessage("Are you sure you want to leave the foods menu? Remember, you can always return to check out our exciting options!");
        builder.setCancelable(true);

        builder.setPositiveButton("Yes", (dialogInterface, i) -> List_Food_Activity.super.onBackPressed());
